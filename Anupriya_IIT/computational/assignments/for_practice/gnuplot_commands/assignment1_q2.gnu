Last login: Fri Sep 25 23:30:17 on ttys001
...
gnuplot> set out 'fit_curve_final.pdf'
gnuplot> set multiplot
multiplot> set size 1,1
multiplot> pl "data_2_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 5 lw 2
multiplot> set size 0.45,0.45
multiplot> set origin 0.5,0.1
multiplot> set tics font "Times-Roman, 12"
multiplot> set xrange[0:20]
multiplot> repl "data_3_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 7 lw 2
...
gnuplot> set multiplot
multiplot> set out 'fit_curve_final.pdf'
                   ^
...
Terminal type is now 'qt'
gnuplot> set multiplot
qt.qpa.fonts: Populating font family aliases took 389 ms. Replace uses of missing font family "Sans" with one that exists to avoid this cost. 
multiplot> set size 1,1
multiplot> set origin 0.1,0.1
multiplot> plot "data_2_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 1 lw 2 title "from data 2"
multiplot> unset origin
multiplot> plot "data_2_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 1 lw 2 title "from data 2"
multiplot> quit
anupriya@KUSHALs-MacBook-Air Desktop % clear
...
Terminal type is now 'qt'
gnuplot> set multiplot
qt.qpa.fonts: Populating font family aliases took 309 ms. Replace uses of missing font family "Sans" with one that exists to avoid this cost. 
multiplot> set size 1,1
multiplot> plot "data_2_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 1 lw 2 title "from data 2"
multiplot> set log y
multiplot> repl
...
Terminal type is now 'qt'
gnuplot> set multiplot
qt.qpa.fonts: Populating font family aliases took 346 ms. Replace uses of missing font family "Sans" with one that exists to avoid this cost. 
multiplot> set size 1,1
multiplot> set log y
multiplot> plot "data_2_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 1 lw 1.5 title "from data 2"
multiplot> repl "data_3_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 3 lw 1.5 title "from data 2"
multiplot> quit
anupriya@KUSHALs-MacBook-Air Desktop % clear
...
Terminal type is now 'qt'
gnuplot> set multiplot
qt.qpa.fonts: Populating font family aliases took 352 ms. Replace uses of missing font family "Sans" with one that exists to avoid this cost. 
multiplot> set size 1,1
multiplot> set log y
multiplot> plot "data_2_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 1 lw 1.5 title "from data 2"
multiplot> repl "data_3_dp.dat" u 1:2 w lp ps 1 pt 7 lt 1 lc 2 lw 1.5 title "from data 3"
multiplot> set size 0.45 0.45
                         ^
...
multiplot> f(x)=exp((a*x)+b)
multiplot> fit f(x) "data_1_dp.dat" u 1:2:5 via a,b
           warning: 
...
a               1.000 
b              -0.938  1.000 
multiplot> pl "data_1_dp.dat" u 1:2:5 w err lw 1.5 title "errorbar on Y",f(x) lw 1.5 title "Best fit curve (x vs y)"
multiplot> g(x)=exp((c*x)+d)
multiplot> fit g(x) "data_1_dp.dat" u 1:3:6 via c,d
           warning: 
	> Implied independent variable y not found in fit function.
	> Assuming version 4 syntax with zerror in column 3 but no zerror keyword.
...
c               1.000 
d              -0.936  1.000 
multiplot> repl "data_1_dp.dat" u 1:3:6 w err lw 1.5 title "errorbar on Z",g(x) lw 1.5 title "Best fit curve (x vs z)"
multiplot> unset multiplot
gnuplot> 
